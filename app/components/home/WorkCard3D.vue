...
// You can add any props or reactive data here if needed
</script>
...
.card {
  height: 100%;
  border-radius: 50px;
  background: linear-gradient(135deg, #5333EC 0%, #32D3D8 100%);
  transition: all 0.5s ease-in-out;
  transform-style: preserve-3d;
  box-shadow: rgba(83, 51, 236, 0) 40px 50px 25px -40px, rgba(83, 51, 236, 0.3) 0px 25px 25px -5px;
}
...
.glass {
  ...
  background: linear-gradient(0deg, rgba(14, 10, 27, 0.5) 0%, rgba(14, 10, 27, 0.8) 100%);
  -webkit-backdrop-filter: blur(5px);
  backdrop-filter: blur(5px);
  transform: translate3d(0px, 0px, 25px);
  border-left: 1px solid #32D3D8;
  border-bottom: 1px solid #32D3D8;
  transition: all 0.5s ease-in-out;
}
...
.bottom .social-buttons-container .social-button {
  ...
  box-shadow: rgba(83, 51, 236, 0.5) 0px 7px 5px -5px;
}
...
.logo .circle {
  ...
  top: 0;
  right: 0;
  box-shadow: rgba(83, 51, 236, 0.4) -10px 10px 20px 0px;
  -webkit-backdrop-filter: blur(5px);
  backdrop-filter: blur(5px);
  background: rgba(50, 211, 216, 0.3);
  transition: all 0.5s ease-in-out;
}
...
.parent:hover .card {
  ...
  box-shadow: rgba(83, 51, 236, 0.4) 30px 50px 25px -40px, rgba(50, 211, 216, 0.3) 0px 25px 30px 0px;
}

.parent:hover .card .bottom .social-buttons-container .social-button {
  transform: translate3d(0, 0, 50px);
  box-shadow: rgba(83, 51, 236, 0.3) -5px 20px 10px 0px;
}
