...
const ui = {
  ...
  indicator: 'absolute top-[4px] duration-200 ease-out focus:outline-none rounded-full bg-[#e1e1e1]/10 dark:bg-[#1b1b1b]',
  trigger: [
    'relative inline-flex items-center justify-center flex-shrink-0 focus:outline-none transition-colors duration-200 ease-out border-[#e1e1e1]/10 border-2',
    ...
    >
      <template #content="{ item }">
        <UAccordion
          ...
          :ui="{
            item: 'mb-2 group px-4 transform-gpu rounded-xl border border-[#e1e1e1]/10 bg-[#e1e1e1]/5 transition duration-500 will-change-transform hover:bg-[#e1e1e1]/[0.075]',
