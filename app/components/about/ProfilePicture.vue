...
<template>
  <div class="flex justify-center">
    <SpotlightCard
      mode="after"
      from="rgba(243,243,243,0.1)"
      :size="400"
      class="group hidden w-64 rounded-2xl border border-[#e1e1e1]/10 bg-[#e1e1e1]/5 p-2 pb-4 sm:flex"
    >
      <div class="relative">
        <NuxtImg
          width="256"
    ...
    <SpotlightCard
      ...
      from="rgba(243,243,243,0.1)"
      :size="400"
      class="group w-64 rounded-2xl border border-[#e1e1e1]/10 bg-[#e1e1e1]/5 p-2 pb-4 sm:hidden"
    >
      <NuxtImg
        width="256"
        :src="profile.picture"
